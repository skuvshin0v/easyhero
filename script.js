...
const trait_list = [
    ...
    },
    {
        ...
        trait_description:`Если вы совершаете проверку, связанную с происхождением работы по камню, прибавьте к результату проверки Истории +${2*prof_bon}`
    },
...
const weapons_list = [
    ...
    { id: "battle9", name: "Кнут", base_char: "dex", hit_die: "1d4", description: "Досягаемость, можно атаковать через Силу или Ловкость" },
    { id: "battle10", name: "Короткий меч", base_char: "dex", hit_die: "1d6", description: "Можно сражаться двумя оружиями, можно атаковать через Силу или Ловкость" },
    ...
    { id: "battle14", name: "Рапира", base_char: "str", hit_die: "1d8", description: "Можно атаковать через Силу или Ловкость" },
    { id: "battle15", name: "Секира", base_char: "str", hit_die: "1d12", description: "Необходимо держать двумя руками" },
    { id: "battle16", name: "Скимитар", base_char: "str", hit_die: "1d6", description: "Можно сражаться двумя оружиями, можно атаковать через Силу или Ловкость" },
...
const specials = [
    ...
    },
    {
        ...
        description: "Своими словами или музыкой вы можете вдохновить одно существо. Оно получает кость бардовского вдохновения — d6. Можете использовать в сутки количество раз равное Харизме."
    },
    {
        id: "bard-master",
    ...
    },
    {
        id: "bard-song",
        name: "Песнь отдыха",
        description: "Вы с помощью успокаивающей музыки или речей можете помочь своим раненым союзникам восстановить 1d6 хитов во время короткого отдыха."
    },
    {
        id: "druid-lang",
    ...
    },
    {
        ...
        name: "Второе дыхание",
        description: "Раз в сутки в свой ход вы можете бонусным действием восстановить 1d10 + 2 хитов"
    },
    {
        id: "warrior-actions",
    ...
    },
    {
        ...
        description: "Когда вы попадаете по существу рукопашной атакой, вы можете потратить 1 заряд заклинаний, чтобы нанести дополнительный урон излучением 2d8. Нежить и Исчадия получают дополнительно +1d8"
    },
    {
        id: "awakened-mind",
        name: "Взор двух умов",
    ...
    },
    {
        id: "god-love",
        name: "Любимчик богов",
        description: "Раз в сутки, если вы проваливаете спасбросок или промахиваетесь в атаке, вы можете бросить 2d4 и добавить результат к своему броску, чтобы изменить исход"
    },
    {
        id: "monk-no-armor",
        name: "Защита без доспехов",
    ...
    },
    {
        ...
        description: "Ваши безоружные удары и атаки монашеским оружием становятся более эффективными. Можете использовать Ловкость вместо Силы для атаки и наносить дополнительные 1d4 урона. Если вы используете действие Атака, вы можете сделать ещё один безоружный удар бонусным действием, если не использовали его в этом ходу"
    },
    {
        id: "ci",
        name: "Очки Ци (2)",
        description: "Вы можете потратить 1 очко Ци на умения монаха"
    },
    {
        id: "ci-wind",
        name: "Поступь ветра",
        description: "Вы можете потратить 1 очко ци в свой ход, чтобы совершить бонусным действием Отход, Рывок ли Уклонение"
    },
    {
        id: "ci-strike",
        name: "Шквал ударов",
        description: "Сразу же после того, как вы в свой ход совершили действие Атака, вы можете потратить 1 очко ци, чтобы бонусным действием совершить два безоружных удара"
    },
];
...
const charms = [
    ...
    },
    {
        id: "sword-burst",
        name: "Вспышка мечей",
        description: "Вы создаёте призрачные лезвия, которые вращаются вокруг вас в радиусе 5 футов. Все существа в пределах этого радиуса должны пройти спасбросок Ловкости, иначе получают 1d6 урона силовым полем"
    },
    {
        id: "mind-sliver",
        name: "Расщепление разума",
        description: "Вы посылаете луч психической энергии в существо в пределах 60 футов. Цель должна пройти спасбросок Интеллекта, иначе она получает 1d6 урона психической энергией и вычитает 1d4 из следующего спасброска до конца вашего следующего хода"
    },
    {
        id: "toll-the-dead",
        name: "Погребальный звон",
        description: "Вы указываете на существо в пределах 60 футов, и оно должно пройти спасбросок Мудрости. При провале цель получает 1d8 некротического урона. Если у существа не полные хиты, оно получает 1d12 урона вместо 1d8"
    },
    {
        id: "guidance",
        name: "Указание",
        description: "Вы касаетесь существа, и оно может один раз в течение следующей минуты добавить 1d4 к одной проверке характеристики на свой выбор"
    },
    {
        id: "word-of-radiance",
        name: "Слово сияния",
        description: "Вы произносите священное слово, излучая обжигающее сияние. Все существа по вашему выбору в пределах 5 футов должны пройти спасбросок Телосложения, иначе получат 1d6 урона излучением"
    },
    {
        id: "friends",
        name: "Дружба",
        description: "Вы получаете преимущество на все проверки Харизмы, направленные на одно не враждебное существо в течение 1 минуты. Когда заклинание оканчивается, существо осознает, что вы использовали магию, и может стать враждебным"
    },
    {
        id: "infestation",
        name: "Нашествие",
        description: "Вы вызываете паразитов, которые обволакивают одно видимое существо в пределах 30 футов. Цель должна пройти спасбросок Телосложения; при провале она получает 1d6 ядовитого урона и перемещается на 5 футов в случайном направлении (бросок d4: 1 — север, 2 — юг, 3 — восток, 4 — запад)"
    },
    {
        id: "primal-savagery",
        name: "Первобытная дикость",
        description: "Вы совершаете рукопашную атаку против существа в пределах 5 футов. При попадании цель получает 1d10 урона кислотой. После атаки ваши зубы или ногти возвращаются в нормальное состояние"
    },
    {
        id: "thorn-whip",
        name: "Терновый кнут",
        description: "Вы совершаете рукопашную атаку заклинанием против существа в пределах 30 футов. При попадании цель получает 1d6 колющего урона и, если она не больше Большого размера, вы подтягиваете её на расстояние до 10 футов к себе"
    },
];
...
const spells = [
    {
        ...
        description: "Вы создаёте три светящихся дротика, которые автоматически поражают выбранные вами цели в пределах дистанции. Каждый дротик наносит 1d4 + 1 урона силовым полем. Все дротики атакуют одновременно, и вы можете направить их в одну или несколько целей"
    },
    {
        id: "disguise",
    ...
    },
    {
        ...
        description: "Когда вы получаете урон от звука, кислоты, огня, холода или электричества, вы можете поглотить часть энергии, получив сопротивление к этому урону до начала вашего следующего хода. В свою следующую рукопашную атаку вы добавляете 1d6 урона этого же типа, после чего заклинание заканчивается"
    },
    {
        id: "sleep",
        name: "Усыпление (1 заряд)",
        description: "Вы погружаете существ в пределах 20 футов от выбранной точки в магический сон. Бросьте 5d8, чтобы определить общее количество хитов, которые могут быть затронуты. Заклинание действует на существ с наименьшим количеством текущих хитов, пока не исчерпается сумма. Спящие существа просыпаются при получении урона или если их разбудят. Нежить и существа, устойчивые к очарованию, не поддаются заклинанию"
    },
    {
        id: "bless",
        name: "Благословение (1 заряд)",
        description: "Вы благословляете до трёх существ в пределах 30 футов. До окончания заклинания каждое благословлённое существо добавляет d4 к броскам атаки и спасброскам. Длительность — до 1 минуты при концентрации"
    },
    {
        id: "shield-of-faith",
    ...
    },
    {
        ...
        description: "При следующем попадании рукопашной атакой ваше оружие вспыхивает светом, нанося дополнительно 1d6 огненного урона и поджигая цель. В начале каждого своего хода цель делает спасбросок Телосложения. При провале она получает 1d6 огненного урона. Заклинание заканчивается при успешном спасброске, тушении пламени или воздействии, которое гасит огонь"
    },
    {
    ...
    },
    {
        ...
        description:"Вы касаетесь существа, восстанавливая ему хиты в размере 1d8 + ваша Мудрость"
    },
    {
        id: "guiding-bolt",
        name: "Направляющий снаряд (1 заряд)",
        description: "Вы выпускаете вспышку света в существо в пределах 120 футов, совершая по нему дальнобойную атаку заклинанием. При попадании цель получает 4d6 урона излучением, и до конца вашего следующего хода следующий бросок атаки по этой цели совершается с преимуществем благодаря тусклому свету, который остаётся на цели"
    },
    {
        id: "bane",
        name: "Порча (1 заряд)",
        description: "До трёх существ в пределах 30 футов должны пройти спасбросок Харизмы. Если они проваливают его, то в течение 1 минуты (при концентрации) вычитают 1d4 из бросков атаки и спасбросков"
    },
    {
        id: "hunters-mark",
        name: "Метка охотника (1 заряд)",
        description: "Вы выбираете существо, и каждый раз при попадании по нему наносите дополнительно 1d6 урона. Также получаете преимущество на проверки Мудрости (Внимание и Выживание) для его поиска"
    },
    {
        id: "goodberry",
        name: "Чудо-ягоды (1 заряд)",
        description: "Вы создаёте 1d10 ягод, каждая из которых восстанавливает 1 хит и насыщает на весь день. Ягоды теряют силу через 24 часа."
    },
    {
        id: "charm-person",
        name: "Очарование личности (1 заряд)",
        description: "Вы очаровываете гуманоида, который должен пройти спасбросок Мудрости. При провале он считает вас своим другом на 1 час или до тех пор, пока вы не нанесёте ему урон. Когда эффект закончится, существо осознает, что было очаровано"
    },
    {
        id: "heroism",
        name: "Героизм (1 заряд)",
        description: "Выбранное вами существо становится неуязвимым к испугу и получает временные хиты, равные вашей Харизме, в начале каждого своего хода в течение 1 минуты. По окончании заклинания временные хиты пропадают"
    },
    {
        id: "price",
        name: "Искажение цены (1 заряд)",
        description: "Вы меняете видимую ценность одного объекта размером не больше одного фута. Можно удвоить его стоимость, добавив иллюзорные украшения, или уменьшить, сделав его менее привлекательным. Изучение предмета с успешной проверкой Интеллекта раскрывает его настоящую цену. Эффект длится 8 часов"
    },
    {
        id: "thunderwave",
        name: "Волна грома (1 заряд)",
        description: "Вы создаете волну громовой силы в кубе 15 футов от себя. Все существа в области эффекта делают спасбросок Телосложения. При провале они получают 2d8 урона звуком и отталкиваются на 10 футов; при успехе получают половину урона и не отталкиваются. Незапрещённые предметы в области эффекта также отталкиваются на 10 футов, а заклинание издает громовой звук, слышимый на 300 футов"
    },
    {
        id: "animal-friendship",
        name: "Дружба с животными (1 заряд)",
        description: "Вы убеждаете выбранного зверя, что не собираетесь ему вредить. Он должен пройти спасбросок Мудрости; при провале он становится очарованным на 24 часа. Если вы или ваши спутники причините ему вред, эффект заклинания заканчивается"
    },
    {
        id: "whitch-bolt",
        name: "Ведьмин снаряд (1 заряд)",
        description: "Вы запускаете луч синеватой энергии к существу в пределах 30 футов. Совершите дальнобойную атаку заклинанием; при попадании цель получает 1d12 урона электричеством. Пока заклинание активно, вы можете в свой ход автоматически наносить 1d12 урона электричеством. Заклинание прекращается, если вы делаете что-то другое, если цель выходит за пределы дистанции или получает полное укрытие"
    },
]
...
const class_properties = {
    ...
    bard: {
        ...
        skills: ["skill-performance","skill-perception","skill-persuasion"],
        charms: ["friends","minor-illusion"],
        spells: ["charm-person","dissonant-whispers","detect-magic","heroism","price"],
    ...
    druid: {
        ...
        charms: ["infestation","primal-savagery","thorn-whip"],
        spells: ["thunderwave","cure-wounds","animal-friendship"],
    ...
    monk: {
        name: "Монах",
        specials: ["monk-no-armor","battlecraft","ci","ci-wind","ci-strike"],
        weapons: ["light1","battle10","light4","light2", "light3", "light5", "light6", "light7", "light8", "light9", "light10", 
            "light11", "light12", "light13", "light14"],
        armor: ["no-armor-monk"],
        skills: ["skill-athletics","skill-stealth"],
        charms: [],
        spells: [],
    ...
    sorcerer: {
        ...
        charms: ["mage-hand","blade-ward"],
        spells: ["whitch-bolt","thunderwave","magic-missile","sleep"],
    ...
    wizard: {
        ...
        weapons: ["light1","light12","light4","light11","light14",],
        armor: ["no-armor"],
        skills: ["skill-arcana","skill-insight"],
        ...
        if (trait.index === "draconic-ancestry") {
            ...
            function updateDragonDescription() {
                ...
                descriptionP.innerHTML = `
                    ...
                    <p>Вы можете действием выдохнуть разрушительную энергию и нанести 2d6 урона ${dragon.element} в виде ${dragon.type}.<br>Соперник должен преуспеть в спасброске ${dragon.saving_throw} со сложностью ${8 + prof_bon + Number(conBonus)}  
                    </p>
...
function updateArmorSelector(selectedClass) {
    ...
    if (!selectedClass || !class_properties[selectedClass]) {
        ...
        zag.innerText = "Выберите класс, чтобы увидеть опции брони";
...
async function parseRace(event) {
    ...
    console.log(traits)
    console.log("Starting profs:",starting_proficiencies)
...
function updateSkillValues(selectedClass) {
    ...
    const raceSkills = starting_proficiencies
    ...
    skillElements.forEach(skillElement => {
        ...
        if (classSkills.includes(skillId)) {
            ...
            console.log(`skill ${skillId} not in a list`)
            if (raceSkills.some(skill => skill.index === skillId)) {
                console.log(skillId);
                skillValue += prof_bon;
            }
    }
